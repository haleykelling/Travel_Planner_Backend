class AccomodationsController < ApplicationController
  ...
  def create
    ...
    @accomodation = Accomodation.new(latitude: latitude, longitude: longitude, name: params[:name], address: params[:address], reservation_number: params[:reservation_number], phone_number: params[:phone_number])
